...
var mod_ts_1 = require("https://deno.land/x/eav@1.0.1/mod.ts");
var decoder = new TextDecoder();
function cmd(exe, args) {
    return __awaiter(this, void 0, void 0, function () {
        var command, output, stdout;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    command = new Deno.Command(exe, {
                ...
                case 1:
                    ...
                    return [2 /*return*/, new mod_ts_1.Err("Error", stdout)];
            }
        });
    });
}
